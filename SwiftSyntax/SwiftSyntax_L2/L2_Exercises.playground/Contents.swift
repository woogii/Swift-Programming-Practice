...
if let artist = paintingDict[painting] {
    ...
    print("there is no value which corresponds to the key Mona Lisa")
}
//: ### Exercise 6
...
if let parentView = childViewController.parentViewController {
    print("there is a parentViewController property")
}
else {
    print("there is no parentViewController")
}
