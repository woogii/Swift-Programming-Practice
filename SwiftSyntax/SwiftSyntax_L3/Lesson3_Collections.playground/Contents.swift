...
moreNumbers += differentNumbers   // compound assignment operator is also available
...
// The code above returns an optional because there's always a chance that key-value pair you are looking for is not in a dictionary
