...
var tempArray = ["true", "false", "true","true","false"]
...
var first_removed = waitingList.removeAtIndex(0)
var second_removed = waitingList.removeAtIndex(0)
admitted.append(first_removed)
admitted.append(second_removed)
...
tempDict["Anchovies"] = true
tempDict["Coconut"] = true
tempDict["Cilanto"] = false
tempDict["Liver"] = false
tempDict
