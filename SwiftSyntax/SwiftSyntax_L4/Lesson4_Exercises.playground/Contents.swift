...
for oldrent in oldMountainViewRent {
    newMountainViewRent.append(oldrent + oldrent * 0.2)
}
...
for (area, code) in rapperPhoneNumbers {
    rapperPhoneNumbers[area] = code.stringByReplacingOccurrencesOfString("415", withString: "510")
}
//: ## Switch Statements
